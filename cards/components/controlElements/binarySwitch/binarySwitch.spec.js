...
describe('BinarySwitch', () => {
  ...
  beforeEach(inject((_$rootScope_) => {
    ...
    makeController = () => {
      return new BinarySwitchController();
    };
  }));
  ...
  describe('Component', () => {
      ...
      let component = BinarySwitchComponent;
